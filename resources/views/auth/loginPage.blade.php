...
<head>
  ...
  <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css" rel="stylesheet"
    integrity="sha384-QWTKZyjpPEjISv5WaRU9OFeRpok6YctnYmDr5pNlyHzz/QGKMp9CBA2qJ+K1+K1/K1+" crossorigin="anonymous">
  <!--===============================================================================================-->
  ...
  <div class="limiter">
    <div class="container-login100" style="background-image: url('/img/login.jpg');">
      <div class="wrap-login100">
        ...
        {{-- Notif Pesan sukses atau error ini --}}
        @if (session('success'))
        ...
        <form class="login100-form validate-form" method="POST" action="{{ route('login.user') }}">
          ...
          <div class="container-login100-form-btn mt-4">
            <p><a href="{{ route('home') }}" class="btn btn-warning">Balik Ke Home</a></p>
          </div>

          <div class="text-center p-t-90 text-white ml-2">
            Belum punya akun? <span><a href="{{ route('get.register') }}"
                style="color: maroon; font-weight: bold">Daftar</a></span>
          </div>
        </form>
        {{-- akhir dari baris proses login --}}
